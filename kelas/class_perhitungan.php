...
class perhitungan{
    ...
    function luasPersegi($bil1, $bil2){
        $bil3=$bil1*$bil2;
        $sisi_a=$bil1;
        $sisi_b=$bil2;
        return "
        Sisi A : ".$sisi_a."<br>
        Sisi B : ".$sisi_b."<br>
        Rumus Luas Persegi = Sisi x Sisi </b> <br>
    ...
    function luasPersegiPanjang($bil1, $bil2){
        ...
        Rumus Luas Persegi Panjang = Panjang x Lebar </b> <br>
    ...
    function luasSegitiga($bil1, $bil2){
        ...
        Rumus Luas Segitiga = 0.5 x Alas x Tinggi </b> <br>
